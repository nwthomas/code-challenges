const getLongestIncreasinsSubsequence = require("./longest-increasing-subsequence");

describe(getLongestIncreasinsSubsequence.name, () => {
    it("should return 1 for all same integers", () => {
        const nums = [8, 8, 8, 8, 8, 8, 8];
        const result = getLongestIncreasinsSubsequence(nums);
